...
- Open `.github/templates/product_spec.md` in a split pane for reference
...
When the user is satisfied, create a summary log file at `rnd/agent_summaries/product-manager-<timestamp>.md` with the following structure:
